...
COMPRESSORS = [
    ...
    {
        "name": "zstd -18",
        "compress":   ["zstd", "-T0", "-18", "-f", "-o", "{output}", "{input}"],
        "decompress": ["zstd", "-T0", "-d", "-f", "-o", "{output}", "{input}"],
        "comp_iters":   1,
        "decomp_iters": 5,
    },
    {
        "name": "zstd -22",
        "compress":   ["zstd", "-T0", "--ultra", "-22", "-f", "-o", "{output}", "{input}"],
        "decompress": ["zstd", "-T0", "-d", "-f", "-o", "{output}", "{input}"],
        "comp_iters":   1,
        "decomp_iters": 5,
    },
    ...
    {
        "name": "xz -5",
        "compress":   ["xz", "-T0", "-5", "-k", "-f", "--stdout", "{input}"],
        "compress_stdout": True,   # xz writes to stdout; we redirect to {output}
        "decompress": ["xz", "-T0", "-d", "-k", "-f", "--stdout", "{input}"],
    ...
    {
        "name": "xz -9",
        "compress":   ["xz", "-T0", "-9", "-k", "-f", "--stdout", "{input}"],
    ...
    {
        "name": "brotli -q9",
        "compress":   ["brotli", "-q", "9", "-f", "-o", "{output}", "{input}"],
        "decompress": ["brotli", "-d", "-f", "-o", "{output}", "{input}"],
        "comp_iters":   1,
        "decomp_iters": 5,
    },
    {
        "name": "brotli -q11",
        "compress":   ["brotli", "-q", "11", "-f", "-o", "{output}", "{input}"],
        "decompress": ["brotli", "-d", "-f", "-o", "{output}", "{input}"],
        "comp_iters":   1,
        "decomp_iters": 5,
    },
