// modified https://github.com/jkbonfield/rans_static/blob/master/permute.h
#if 0
#    include <stdio.h>
 ...
 * a problem.
 *
 * #define PM(a,b,c,d,e,f,g,h)
 * ((a<<0)|(b<<4)|(c<<8)|(d<<12)|(e<<16)|(f<<20)|(g<<24)|(h<<28))
 *
